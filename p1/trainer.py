...
class Trainer(object):
    def __init__(self, train_data_loader, valid_data_loader, batch_size, grad_accumulate_steps):
        ...
        # Path
        self.model_save_path = "p1/checkpoint3"
    ...
    def train(self):
        ...
        np.save("p1/train_loss", train_loss)
        np.save("p1/train_accu", train_accu)
        np.save("p1/valid_loss", valid_loss)
        np.save("p1/valid_accu", valid_accu)
